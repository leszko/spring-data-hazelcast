...
public class TestConstants {
	...
	public static final String LANGUAGE_MAP_NAME = "Language";
	...
	public static final String[] OSCAR_MAP_NAMES = { LANGUAGE_MAP_NAME, MAKEUP_MAP_NAME, 
			MOVIE_MAP_NAME, PERSON_MAP_NAME, SONG_MAP_NAME };
}
